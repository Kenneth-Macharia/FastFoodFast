...
class DatabaseSetup(object):
    ...
    def setup_conn(cls, request_type):
        ''' Setup the connection to the database, configurations
        set and fetched from the OS '''
        ...
        # Testing code while app is in development, will not be
        ...
        DatabaseSetup.setup_tables(db_configs)
        return connection
